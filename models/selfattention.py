...
class SelfAttention(nn.Module):
    ...
    def forward(self, hidden_states, hidden_states_c): #, attention_mask
        ...
        mixed_key_layer = self.key(hidden_states_c)       # [bs, seqlen, hid_size]
        mixed_value_layer = self.value(hidden_states_c)   # [bs, seqlen, hid_size]
