...
from dataset.sc_dataset import sc_dataset
...
def create_dataset(dataset, config):
    ...
    if dataset=='pretrain':
        ...
        train_dataset = sc_dataset(config['train_file'], train_transform)  
        val_dataset = sc_dataset(config['val_file'], test_transform)  
        test_dataset = sc_dataset(config['test_file'], test_transform)                
        return train_dataset, val_dataset, test_dataset   
